...
<body class="hold-transition sidebar-mini">
                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button type="button" id="periksaButton"
                                                        class="btn btn-info  btn-flat periksa-button"
                                                        onclick="redirectToPeriksa(<?= $poli->id_pasien; ?>, '<?= $poli->nama_pasien; ?>')">
                                                        <i class=" fa fa-regular fa-stethoscope"></i> Periksa
                                                    </button>
                                                </td>
                                                <td>
                                                    <button type="button" id="periksaButton"
                                                        class="btn btn-warning  btn-flat periksa-button">
    ...
    <script>
    function redirectToPeriksa(id_pasien, nama_pasien) {
        window.location.href = '<?= base_url('dokter/periksa/index/'); ?>' + id_pasien + '/' + encodeURIComponent(
            nama_pasien);
    }
    </script>
