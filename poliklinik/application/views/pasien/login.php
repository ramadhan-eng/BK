...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="../../index2.html"><b>Pasien</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?= base_url('pasien/login/process_login') ?>" method="post">
                    <div class="input-group mb-3">
                        <input type="username" class="form-control" placeholder="Nama" name="nama">
                ...
                <p class="mb-0">
                    <a href="<?= base_url('pasien/registasi') ?>" class="text-center">Register a new membership</a>
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>
    ...
    <!-- Bootstrap 4 -->
    <script src="<?= base_url('asset/') ?>AdminLTE/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- AdminLTE App -->
